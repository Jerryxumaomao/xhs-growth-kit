...
│   ├── opinion-video.md               # ✅ 观点视频（中文，抖音播放量校准 25+ 样本）
│   ├── opinion-video-zero.md          # ✅ v0 等权占位（cold-start）
│   ├── xhs-zhongcao-zero.md           # ✅ 小红书种草/好物分享（北极星=收藏率/藏曝比；图文+视频；银饰/香水锚点）
│   ├── xhs-zhangfen-zero.md           # ✅ 小红书涨粉/口碑（北极星=关注转化率；口碑副信号=分享率+评论正向率；图文+视频）
